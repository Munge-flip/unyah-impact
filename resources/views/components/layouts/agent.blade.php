    ...
    <main class="dashboard-container">
        ...
        <aside class="sidebar">
            <div class="sidebar-menu">
                <button class="menu-btn active" data-section="account">
            ...
            <div id="account-section" class="content-section active">
                ...
                <div class="agent-profile-card">
                    <div class="profile-header">
                        <div class="avatar">
                            <img src="img/weblogo.png" alt="Agent Avatar">
                        </div>
                        <div class="profile-info">
                            <h2>U***nh</h2>
                            <p class="agent-role">Agent</p>
                        </div>
                    </div>
                    ...
                    <div class="chat-box">
                        <div class="chat-messages" id="chatMessages">
                            <div class="chat-empty">
                                ...
                                <p>No messages yet</p>
                                <span>Start a conversation with customers</span>
                            </div>
                        </div>
                        <div class="chat-input-container">
                            <input type="text" id="chatInput" placeholder="Message Customer" class="chat-input">
